...
public class Two_player_game extends AppCompatActivity implements View.OnClickListener  {

    ImageView Box_1,Box_2,Box_3,Box_4,Box_5,Box_6,Box_7,Box_8,Box_9, backBtn;
    CircularImageView playerOneImg , playerTwoImg;
    TextView t1,t2;
    TextView playerOneWins, playerTwoWins;
    ImageView clickImg;
    ...
    private void quitDialogfun() {
        ...
        quitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                quitdialog.dismiss();
                Intent intent = new Intent(Two_player_game.this, MainActivity.class);
